const wards = [
  {id:"TDP01",name:"Phượng Sơn",source:"Phượng Sơn cũ",old:["Trại 1","Đầm","Cầu Đất","Mào Gà"],households:881,population:3386,secretary:"Thân Văn Yên",secretaryPhone:"0916 459 170",leader:"Đỗ Đức Hảo",leaderPhone:"0962 168 226",front:"Trần Huy Hoan",frontPhone:"",x:58.3,y:52.4,color:"#efc7c7",halo:[132,92]},
  ...
  {id:"TDP04",name:"Cầu Từ",source:"Phượng Sơn cũ",old:["Hạ Mã","Cầu Từ","Phú Bòng"],households:623,population:2141,secretary:"Trần Danh Tuyên",secretaryPhone:"0972 837 826",leader:"Nguyễn Văn Định",leaderPhone:"0378 261 328",front:"Nguyễn Đức Quyền",frontPhone:"",x:23.5,y:64.5,color:"#f5e7aa",halo:[104,72]},
  ...
  {id:"TDP07",name:"Xuân An",source:"Mỹ An cũ",old:["Xuân An","Tân Giang","Đồng Trắng"],households:604,population:2365,secretary:"Phạm Ngọc Mạnh",secretaryPhone:"0385 181 115",leader:"Trương Văn Dựng",leaderPhone:"0978 434 262",front:"Nguyễn Tiến Toàn",frontPhone:"",x:58.4,y:65.7,color:"#c5eeee",halo:[105,104]},
  ...
  {id:"TDP11",name:"Đồng Giao",source:"Quý Sơn cũ",old:["Thượng Vũ","Đồng Giao"],households:531,population:2362,secretary:"Lê Thành Đồng",secretaryPhone:"0912 436 708",leader:"Hoàng Đức Duy",leaderPhone:"0981 114 497",front:"Nguyễn Văn Khởi",frontPhone:"",x:65.7,y:27.7,color:"#c7efbd",halo:[95,104]},
  ...
  {id:"TDP14",name:"Trại Cháy",source:"Quý Sơn cũ",old:["Thum Mới","Trại Cháy","Nhất Thành"],households:587,population:2436,secretary:"Vi Văn Dương",secretaryPhone:"0568 353 888",leader:"Nguyễn Văn Ngọc",leaderPhone:"0357 922 878",front:"Nông Thị Hoan",frontPhone:"",x:46,y:48.1,color:"#f6e8ad",halo:[115,92]},
  {id:"TDP15",name:"Thum Bắc",source:"Quý Sơn cũ",old:["Thum Cũ","Bắc Một"],households:499,population:2292,secretary:"Nguyễn Văn Thanh",secretaryPhone:"0365 909 304",leader:"Tạ Văn Tư",leaderPhone:"0984 069 296",front:"Viên Thị Bé",frontPhone:"",x:45.6,y:41.2,color:"#cfd8ef",halo:[82,108]},
  ...
  detailContent.innerHTML=`
    ...
    <section class="detail-section">
      ...
      <div class="detail-box">
        ...
        ${ward.frontPhone?leaderRow("Trưởng Ban CTMT",ward.front,ward.frontPhone):`<div class="detail-row">Trưởng Ban CTMT: <strong>${escapeHtml(ward.front)}</strong> — đề nghị bổ sung số điện thoại</div>`}
      </div>
    </section>
    <section class="detail-section">
    ...
    <section class="detail-section">
      ...
      <div class="detail-box"><div class="detail-row">Di tích, sản phẩm OCOP và diện tích riêng của TDP: <strong>đang đối chiếu</strong>.</div><a class="maps-search" href="${mapsSearchUrl(`TDP ${ward.name}, phường Phượng Sơn, Bắc Ninh`)}" target="_blank" rel="noopener">Mở tìm kiếm khu vực trên Google Maps ↗</a></div>
